...
## Fork Changes (y-l-mochizuki/claude-code-action@beta)
...
- **Updated Base Action**: Uses `y-l-mochizuki/claude-code-base-action@beta` which includes OAuth credential handling
